...
export async function POST(
  ...
  try {
    ...
    const provider: string = body.provider ?? 'heygen';
    ...
    return NextResponse.json({
      ...
      message: `${provider === 'heygen' ? 'HEYGEN_API_KEY' : 'RUNWAY_API_KEY'} not configured. Add it to your .env to enable AI video generation.`,
      supported_providers: [
